...
-- ─── Insert ALL options (all nodes exist, FKs resolve) ───────────────────────

-- Q1: Project type (sets project_type for package matching)
...
-- Q6: Animation preference (terminal — NULL next_node_id)
INSERT INTO quiz_options (id, node_id, label_en, label_ru, next_node_id, project_type, style_weights, sort_order) VALUES
